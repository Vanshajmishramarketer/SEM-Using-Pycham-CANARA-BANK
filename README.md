...
df = pd.read_csv(r"D:\canaraBS.csv").dropna()
...
pos = {"FinancialStrength": (0, 1),"TAD": (0, 0),   "FSxTAD": (0, -1),  "TotalAssets": (2, 0)}
plt.figure(figsize=(8,6))
nx.draw(   G, pos,  with_labels=True,   node_size=3500,    node_color="lightgray",   font_size=10,   arrowsize=20)
plt.title("VANSHAJ MISHRA SEM with TAD as Moderating Variable")
plt.show()
